module.exports = {
    ...
    , origensPermitidas: 'http://localhost:4200' // se usar asterisco (*) em vezes de especificar um dominio, permitirá requisições de todos os dominios cruzados (all cross domain)
